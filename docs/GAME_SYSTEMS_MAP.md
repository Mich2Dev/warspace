...
> **Capas técnicas (código):** [`LAYERS.md`](LAYERS.md) — navegación, terreno, enemigos, UI, etc.  
> Este doc = **capas de gameplay** (historia, eventos, farm, economía).

---

## 0) Dos tipos de "capas"

| Tipo | Doc | Ejemplo |
|------|-----|---------|
| **Gameplay** | Este archivo | Misiones, eventos, tienda |
| **Técnica** | `LAYERS.md` | worldNav, terrainRules, Environment |

No confundir: "capa de navegación" = L2 técnica. "capa de farm" = gameplay libre.
...
- `LAYERS.md` — **índice capas técnicas L0–L7** (navegación, terreno, bots…).
- `WORLD_ACCESSIBILITY.md` — profundidad capa L2 (mapa, corredores, spawns).
...
- `ARCHITECTURE.md` — flujo de codigo y refactor.
